...
ActiveRecord::Schema[8.0].define(version: 2025_07_12_194824) do
  ...
  create_table "principio_ativos", force: :cascade do |t|
    t.string "nome"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "produtos", force: :cascade do |t|
    ...
    t.bigint "principio_ativo_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["fabricante_id"], name: "index_produtos_on_fabricante_id"
    t.index ["principio_ativo_id"], name: "index_produtos_on_principio_ativo_id"
  end
  ...
  add_foreign_key "produtos", "fabricantes"
  add_foreign_key "produtos", "principio_ativos"
end
